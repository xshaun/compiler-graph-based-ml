...
def programl_deps():
  ...
  http_archive(
    name="llvm",
    # exp at centos.
    sha256="4d340d9a0f643f9b6260296a932c882ee1cf38f6ac36decdc76ce2dccf771966",
    strip_prefix="compiler-bazel-llvm-0.3-alpha", 
    urls=[
      "https://github.com/xshaun/compiler-bazel-llvm/archive/v0.3-alpha.tar.gz"
    ],
    # ubuntu support

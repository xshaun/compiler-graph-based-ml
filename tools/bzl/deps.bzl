...
def programl_deps():
  ...
  http_archive(
    ...
    # todo?
    # exp at centos
    sha256="9297daeb073c54826ba79bcdab5500691baa43af546b2dcbc8c0412b0ed51d27",
    strip_prefix="compiler-bazel-llvm-0.2-alpha", 
    urls=[
      "https://github.com/xshaun/compiler-bazel-llvm/archive/v0.2-alpha.tar.gz"
    ],

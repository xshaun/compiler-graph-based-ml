...
def programl_deps():
  ...
  http_archive(
    ...
    # todo?
    # exp at centos
    sha256="c72a9088e0b1bf075b63754d8916284b6deff153b83f3209d3e84609a385213b",
    strip_prefix="compiler-bazel-llvm-0.1-alpha", 
    urls=[
      "https://github.com/xshaun/compiler-bazel-llvm/archive/v0.1-alpha.tar.gz"
    ],
